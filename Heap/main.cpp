...
#include <iostream>
#include <vector>
#include <algorithm> 			//sort-hoz kell
#include <cstdio>
#include <cstdlib>
#include <ctime>
#include "pqueue.hpp"
...
int main ()
{
	...
	try
	{
        ...
        std::vector<int> t2 = t;		//lemásoljuk az eredeti vektort,
                						//melyet aztán a std::sort-tal is berendezünk

        heapSort(t);
        std::cout << std::endl << "rendezve kupaccal: " << std::endl;
        for(int i=0; i<ARRAY_SIZE; ++i)
        {
            std::cout << t[i] << ' ';
        }
        ...
        std::cout << std::endl << "rendezve std::sort-tal: " << std::endl;
        for(int i=0; i<ARRAY_SIZE; ++i)
        {
            std::cout << t2[i] << ' ';
        }
